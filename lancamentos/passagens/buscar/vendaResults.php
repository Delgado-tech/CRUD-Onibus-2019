    ...
    <div class="nav-wrapper grey darken-3">
      <form>
        <div class="input-field">
          <input value="'.$navbar.'" id="search" placeholder="Pesquisar por Passagem..." name="navbar" type="search" required>
...
';
  ...
  ";
	...
	$sql = mysqli_query($conexao,"SELECT * FROM LCMT_VIAGEM_PASS WHERE ROTA3 LIKE '%$navbar%'
	OR DATA_VIAGEM2 LIKE '%$navbar%' ORDER BY ROTA3 ASC");
	...
	echo "
	  ...
	  ";
		...
		echo "<center><h1>Nenhuma Passagem Encontrada</h1></center>";
	}
?>	
