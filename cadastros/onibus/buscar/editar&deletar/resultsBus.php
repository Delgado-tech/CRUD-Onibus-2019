...
echo '
    ...
    <div class="nav-wrapper purple darken-4">
      <form>
        <div class="input-field">
          <input id="search" value="'.$navbar.'" placeholder="Pesquisar por Ônibus..." name="navbar" type="search" required>
  ...
  <a class='btn tooltipped purple darken-4' href='../../cadBusMain.php'><b><</b></a>
      
  ";
	
	$sql = mysqli_query($conexao,"SELECT * FROM CAD_ONIBUS WHERE PLACA LIKE '%".$navbar."%' ORDER BY PLACA ASC");
	...
	echo "
        <tbody>
          <tr>
			...
			<a href='deletarBus.php?placa=".$placa."' 
	  ...
	  ";
		...
		echo "<center><h1>Nenhum Ônibus Encontrado</h1></center>";
	}
