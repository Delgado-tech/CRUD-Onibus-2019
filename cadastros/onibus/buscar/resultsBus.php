    ...
    <div class="nav-wrapper grey darken-3">
      <form>
        <div class="input-field">
          <input id="search" placeholder="Pesquisar por Ônibus..." value="'.$navbar.'" name="navbar" type="search" required>
...
';
  ...
  ";
	...
	$sql = mysqli_query($conexao,"SELECT * FROM CAD_ONIBUS WHERE PLACA LIKE '%".$navbar."%' 
	ORDER BY PLACA ASC");
