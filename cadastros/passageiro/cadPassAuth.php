...
$noRepeat = mysqli_query($conexao,"SELECT CPF FROM CAD_PASSAGEIRO WHERE CPF='$passCpf'");
...
|| $row > 0 || $passCpf != $cpfcorrection || $cpfSize != 11) //tipos de erro;
{
	...
	echo "
		...
		$sql = mysqli_query($conexao,"INSERT INTO CAD_PASSAGEIRO VALUES('$passCpf','$passName','$passCity',
'$passState','$mysqliDateFormat','$passObs')") or die(mysqli_error($conexao));
		
		echo "<div class='container'>
		<h1 class='center-align'>Cadastrando Passageiro! Aguarde...</h1>
		";
		echo "<div class='progress'>
			...
			";
		header("refresh:3;url='cadPassMain.php'");
}
