...
<?php
  ...
  ";
	...
	$sql = mysqli_query($conexao,"SELECT * FROM CAD_PASSAGEIRO WHERE PASS_NAME LIKE '%$navbar%' OR
	CPF LIKE '%$navbar%' ORDER BY PASS_NAME ASC");
	...
	echo "
	  ...
	  ";
		...
		echo "<center><h1>Nenhum Passageiro Encontrado</h1></center>";
	}
?>	
