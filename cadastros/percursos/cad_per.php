...
<head>
	...
	<br>
	<a class="btn tooltipped" href="cadPerMain.php"><b><</b></a>
		<h1>Criação de Percurso</h1>
		
		  <div class="row"> 
    <form class="col s12" name="formCadUser" method="POST" action="cadPerAuth.php">
      <div class="row">
        <div class="input-field col s4">
          <input placeholder="Ponto de saída do Ônibus (ex: Av. Nogueira Padilha)" 
		  id="saidaPer" type="text" class="validate" name="saidaPer">
          <label for="saidaPer">Saída</label>
        </div>
		<div class="input-field col s4">
          <input placeholder="Ponto de chegada do Ônibus (ex: rua: Jardim Europa)" 
		  id="destinoPer" type="text" class="validate" name="destinoPer">
          <label for="destinoPer">Destino</label>
        </div>
		<div class="input-field col s2">
          <input placeholder="(Usar apenas Números)" 
		...
		<div class="row">
        <div class="input-field col s2">
          <input placeholder="Ex: 4.90(usar apenas números)" 
	   ...
	   <div class="right-align" style="margin-right:50px;"><input type="submit" value="Enviar" class="btn"></div>
		...
		<fieldset><legend>
          ...
          <input id="motqntd" value="1" type="text" name="motqntd" data-length="2">
			</fieldset>
		<p id="row1"></p>
		...
		<p><label>
		<input type="checkbox" name="openvendas" class="filled-in"/>
