...
mysqli_query($conexao,"DELETE FROM CAD_PERCURSO WHERE ROTA = '$ROTA'") or die(mysqli_error($conexao));
...
echo "<center><h1 style='color: #d32f2f'>Deletando Percurso</h1></center>";
