...
if($row > 0){
	...
	mysqli_query($conexao,"INSERT INTO CAD_PERCURSO VALUES('$rota','$tempoPer','$trocaMot',
'$motqntd','$openvendas','$custoPer','$custoPerBag')") or die(mysqli_error($conexao));
		
		echo "<div class='container'>
		<h1 class='center-align'>Criando Percurso! Aguarde...</h1>
		";
		echo "<div class='progress'>
			...
			";
		header("refresh:3;url='cadPerMain.php'");
