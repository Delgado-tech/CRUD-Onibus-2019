...
if($mysqliDateFormat == "" || $CNHtipo == "")
{
	...
	mysqli_query($conexao,"UPDATE CAD_MOTORISTA SET MOT_NAME='$motName',ENDERECO_M='$motRua',
NUMERO_M='$motNumCasa',BAIRRO_M='$motBairro',CIDADE_M='$motCity',ESTADO_M='$motState',
CEP_M='$motCEP',FONE_M='$motPhone',MOT_NASC='$motNasc',CNH_VENC='$mysqliDateFormat',
CNH_TIPO='$CNHtipo' WHERE COD_MOT = '$id'") or die(mysqli_error($conexao));
		
		echo "<div class='container'>
		<h1 class='center-align'>Atualizando Motorista! Aguarde...</h1>
		";
		echo "<div class='progress'>
			...
			";
		header("refresh:3;url='editarMot.php'");
}
